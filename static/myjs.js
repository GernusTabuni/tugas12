function post() {
  ...
  function update_profile() {
    ...
    function toggle_like(post_id, type) {
        ...
        // Define icons for thumbs-up and star
        let $i_thumbs_up = $(`#${post_id} a[aria-label='thumbs-up'] i`);
        let $i_star = $(`#${post_id} a[aria-label='star'] i`);
        ...
        $.ajax({
            ...
            data: {
                post_id_give: post_id,
                type_give: type,
                action_give: $i_like.hasClass("fa-heart") ? "unlike" : "like",
            },
            success: function (response) {
                if (response["result"] === "success") {
